...
HD_PWD='C:/XilinxProjects/mtrxmlt_vrlg/mtrxmlt_vrlg.runs/matrix_out_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_out.tcl
