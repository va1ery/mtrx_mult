...
#
# Generated by Vivado on Mon May 02 11:07:07 +0300 2022
...
# Script info
echo -e "Matrix_B.sh - Script generated by export_simulation (Vivado v2019.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Matrix_B xil_defaultlib.Matrix_B xil_defaultlib.glbl -log elaborate.log
}
